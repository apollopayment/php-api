...
use ApolloPayment\Enums\TariffActions;
use ApolloPayment\Enums\TariffTypes;
...
class PartnerApi
{
    ...
    {
        $this->instance = new Instance($publicKey, $privateKey, 'https://app.apollopayment.io/partner/api');
    }
